...
<div class="error_main">
    <p style="margin-left:10px;font-size:14px;font-weight:bold;color:#F90;padding-top:10px;">Oop's</p>
        <p style="margin-left:10px;font-size:14px;color:#F90;">The email or password you entered is incorrect.</p>
    </div>
</div>
<?php } ?>
