...
$article_insrt=mysql_query("DELETE FROM `tbl_meta_description_final` WHERE session_id='$id' and keyword='$keyword_keynew' ");

$insertmetyadec=mysql_query("INSERT INTO `tbl_meta_description_final`(`session_id`, `metadescription`, `keyword`) VALUES ('$id','$metades','$keyword_keynew')");	
